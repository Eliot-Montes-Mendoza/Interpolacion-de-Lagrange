    ...
    ui(new Ui::Lagrange)
{
    ui->setupUi(this);
     ...
     ui->valorx->setDisabled(true);

}
void Lagrange::cargar(){// This slot will save the data from table widget to arrays, when the Load button been clicked.
...
void Lagrange::ejecutar(){// This slot will run the method, when the Start button been clicked after data introduction.
...
void Lagrange::limpiar(){// This slot will clear all user interface fields, when the Clear button been clicked.
